...
namespace laotze
{
    class Program: CommandLineInterface
    {
        ...
        {
            ISchemaExtractor extractor = Incubator.Default.Get<ISchemaExtractor>(new SQLiteSchemaExtractor(DefaultDataDirectoryProvider.Current.GetSysDatabase(connectionName)));
